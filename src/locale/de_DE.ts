...
export const de_DE: typeof zh_CN = {
  ...
  SETTING_HK4E_FPS_SAVE_ERROR:
    "FPS-Einstellungen konnten nicht gespeichert werden. Ändere die Einstellung, um es erneut zu versuchen.",
  ...
  SETTING_GAME_MODE_DESC: "macOS-Spielmodus im nativen Vollbild erlauben.",
  SETTING_NATIVE_FULLSCREEN: "Native macOS fullscreen",
  SETTING_NATIVE_FULLSCREEN_DESC: "Grüne Taste: eigener Desktop.",
