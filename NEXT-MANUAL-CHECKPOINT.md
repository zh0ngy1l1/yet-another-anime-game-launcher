...
The old checkpoint remains in Git history at `7eb7e4a` and in retained local
evidence. Its private candidate paths and unrun instructions are historical.
Working-installation activation remains a separate final user action.
